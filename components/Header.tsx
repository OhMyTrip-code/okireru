  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/40 bg-white/85 backdrop-blur">
      <Container className="flex items-center justify-between gap-4 py-4">
        <Link href="#hero" aria-label="オキレル ホームに戻る">
        ...
        <div className="flex items-center gap-3">
          <Link href="#cta" className={buttonClasses("primary", "hidden md:inline-flex")}>
            今すぐ事前登録
          </Link>
          <Link href="#cta" className={buttonClasses("secondary", "md:hidden")}>
            事前登録
          </Link>
        </div>
      </Container>
